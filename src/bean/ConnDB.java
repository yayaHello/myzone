...
public class ConnDB {
    ...
    private static String propFileName = "bean/connDB.properties"; // 指定资源文件保存的位置
    ...
    private static String dbUrl = "jdbc:mysql://localhost:3306/book?user=root&password=123456&useUnicode=true";
    public ConnDB() {
        try {			//捕捉异常
